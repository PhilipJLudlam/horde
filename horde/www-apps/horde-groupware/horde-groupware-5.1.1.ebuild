...
SRC_URI="http://pear.horde.org/get/groupware-5.1.1.tgz"
...
RDEPEND="${DEPEND}
	...
	>=www-apps/horde-content-2.0.3
	>=www-apps/horde-gollem-3.0.0
	>=www-apps/horde-horde-5.1.2
	>=www-apps/horde-kronolith-4.1.2
	>=www-apps/horde-mnemo-4.1.1
	>=www-apps/horde-nag-4.1.1
	>=www-apps/horde-timeobjects-2.0.3
	>=www-apps/horde-trean-1.0.3
	>=www-apps/horde-turba-4.1.1"
...
src_install() {
    ...
    for i in horde-content horde-gollem horde-horde horde-kronolith horde-mnemo horde-nag horde-timeobjects horde-trean horde-turba
    do
