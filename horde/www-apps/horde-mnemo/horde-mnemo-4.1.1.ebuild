...
SRC_URI="http://pear.horde.org/get/mnemo-4.1.1.tgz"

LICENSE="ASL"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~ppc ~ppc64 ~s390 ~sh ~sparc ~x86"
IUSE="horde-horde_activesync horde-horde_cli horde-horde_crypt horde-horde_db horde-horde_pdf horde-horde_test"
...
RDEPEND="${DEPEND}
	...
	>=dev-php/horde-Horde_History-2.1.0
