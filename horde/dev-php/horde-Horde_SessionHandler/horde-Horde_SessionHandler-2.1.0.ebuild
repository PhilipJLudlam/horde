...
SRC_URI="http://pear.horde.org/get/Horde_SessionHandler-2.1.0.tgz"

LICENSE="LGPL-2.1"
SLOT="0"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~ppc ~ppc64 ~s390 ~sh ~sparc ~x86"
IUSE="horde-horde_db horde-horde_log horde-horde_memcache horde-horde_mongo horde-horde_test"
