...
SRC_URI="http://pear.horde.org/get/Horde_Core-2.6.0.tgz"

LICENSE="LGPL-2.1"
SLOT="0"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~ppc ~ppc64 ~s390 ~sh ~sparc ~x86"
IUSE="horde-horde_activesync horde-horde_crypt horde-horde_dav horde-horde_db horde-horde_editor horde-horde_elasticsearch horde-horde_form horde-horde_hashtable horde-horde_http horde-horde_icalendar horde-horde_image horde-horde_imap_client horde-horde_kolab_server horde-horde_kolab_session horde-horde_kolab_storage horde-horde_ldap horde-horde_mail horde-horde_mongo horde-horde_nls horde-horde_oauth horde-horde_queue horde-horde_routes horde-horde_service_twitter horde-horde_spellchecker horde-horde_test horde-horde_tree horde-horde_vfs pear-net_dns2 pear-text_captcha pear-text_figlet pear-text_languagedetect"
...
RDEPEND="${DEPEND}
	...
	horde-horde_dav? ( >=dev-php/horde-Horde_Dav-1.0.0_alpha1 )
